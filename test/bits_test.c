...
static void test_bits_set_predicates_and_delete_all() {
...
static void test_bits_pop_low_returns_low_set_bits_and_clears_them() {
...
static void test_bits_push_low_returns_low_clear_bits_and_sets_them() {
...
static void test_bits_span_sets_low_bits() {
...
static void test_bits_range_sets_half_open_range() {
...
static void test_bits_add_span_sets_low_bits() {
  test_eq_U64(
    bits_add_span((Bits)1 << 5u, 4), ((Bits)1 << 5u) | expected_bits_span(4)
  );
}

static void test_bits_del_span_clears_low_bits() {
